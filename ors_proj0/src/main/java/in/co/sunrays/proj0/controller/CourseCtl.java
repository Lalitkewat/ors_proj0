...
public class CourseCtl extends BaseCtl
{
   ...
   public String submit(@ModelAttribute("form") @Valid CourseForm form,BindingResult result,Model model,Locale locale,HttpSession session) throws DuplicateRecordException
   {
	   String entername=messageSource.getMessage("label.entercoursename",null,locale);
		model.addAttribute("enterName",entername);
