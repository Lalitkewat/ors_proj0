...
public class RoleCtl extends BaseCtl
{
	...
	public String submit(@RequestParam(required=false) Long id,@ModelAttribute("form") @Valid RoleForm form , BindingResult result ,Model model,Locale locale,HttpSession session) throws DuplicateRecordException
	{
		String enterName=messageSource.getMessage("label.enterrname",null,locale);
		model.addAttribute("enterName",enterName);
