...
public class CollegeCtl extends BaseCtl
{
	...
	public String submit(@RequestParam(required=false) Long id,@ModelAttribute("form") @Valid CollegeForm form , BindingResult result , Model model , Locale locale,HttpSession session) throws DuplicateRecordException
	{
		String entername=messageSource.getMessage("label.entercname",null,locale);
		model.addAttribute("enterName",entername);
		...
		if(OP_SAVE.equalsIgnoreCase(form.getOperation()))
		{
			...
			dto.setCreatedBy(userDto.getEmailId());
			dto.setModifiedBy(userDto.getEmailId());
